...
public class EngineerList extends ArrayAdapter<Data> {
    private Activity context;
    List<Data> clients;

    public EngineerList(Activity context, List<Data> clients) {
        super(context, R.layout.activity_engineer_list, clients);
